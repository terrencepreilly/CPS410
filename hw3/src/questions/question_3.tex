...
\addcontentsline{toc}{subsection}{Interface Specifications}
    % Terrence's portion
...
\addcontentsline{toc}{subsection}{Class Definitions}
    \begin{itemize}
...
\addcontentsline{toc}{subsection}{Pseudocode}
...
\addcontentsline{toc}{subsection}{Data File Specifications}
